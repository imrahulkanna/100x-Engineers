      ...
      <main className="flex flex-col items-start gap-10 px-7">
        ...
        <div className="flex flex-col items-start gap-5 self-stretch">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-signup-radius border border-stroke px-6 py-2 text-base font-bold leading-normal text-twitter-blue shadow-signup backdrop-blur-xl-1"
          >
            Sign in
          </button>
        </div>
